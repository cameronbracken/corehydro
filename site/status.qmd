...
RMC-BestFit `DataFrame` facades that had been waiting on it. The heavy `TimeSeries` container
landed in v0.13.0 -- the last unported portable slice -- together with the four members deferred
alongside it.
