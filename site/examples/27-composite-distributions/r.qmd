...
That is the honest limit of a kernel density for design work. It describes the record it was
built from and will not extrapolate past it, which is exactly why the parametric fits above still
have a job.
...
Removing the impossible lower tail pushes every quantile up, proportionally most at the median
and least in the tail that mattered anyway.
