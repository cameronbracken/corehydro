...
that first step; passing an already-parameterized `distribution()` object attaches it as given
and skips the fit. A named marginal is rejected under `"mpl"` and `"tau"`, since neither method
looks at marginals and the name would come back unfitted.
...
```{r}
#| fig-alt: "And-joint exceedance probability against common marginal annual exceedance probability for the Gumbel copula, the Normal copula, and independence, on logarithmic axes."
